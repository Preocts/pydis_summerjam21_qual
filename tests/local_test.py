...
class MakeTableTests(unittest.TestCase):
    ...
    def test_003_creates_rows(self) -> None:
        ...
        for case, expect in zip(cases, expected):
            self.assertEqual(
                ...
                expect,
                msg="Failed when creating multiple rows.",
            )
    ...
    def test_004_creates_cols(self) -> None:
        ...
        for case, expect in zip(cases, expected):
            self.assertEqual(
                make_table(**vars(case)),
                expect,
                msg="Failed when creating multiple columns.",
            )
    ...
    def test_005_creates_label(self) -> None:
        ...
        for case, expect in zip(cases, expected):
            self.assertEqual(
                make_table(**vars(case)), expect, msg="Failed when creating labels."
            )
    ...
    def test_006_align_center(self) -> None:
        ...
        for case, expect in zip(cases, expected):
            self.assertEqual(
                make_table(**vars(case)),
                expect,
                msg="Failed when using align_center parameter.",
            )
    ...
    def test_010_lots_of_rows(self) -> None:
        ...
        self.assertEqual(
            make_table(rows), expected_1, msg="Couldn't handle lots of rows."
        )
        self.assertEqual(
            make_table(rows, centered=True),
            expected_2,
            msg="Couldn't handle lots of rows.",
        )
    ...
    def test_011_lots_of_columns(self) -> None:
        ...
        self.assertEqual(
            make_table(rows), expected_1, msg="Couldn't handle lots of cols."
        )
        self.assertEqual(
            make_table(rows, centered=True),
            expected_2,
            msg="Couldn't handle lots of cols.",
        )
